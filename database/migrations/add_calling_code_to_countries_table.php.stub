...
return new class extends Migration
{
	 ...
	 * Run the migration.
	 *
	 * Adds the ITU-T E.164 calling code column to countries and backfills
	 * known values. Idempotent: safe even if the column already exists
	 * (e.g. on fresh installs where the create migration already added it).
	 *
	 * @return void
	 */
		...
		if (!Schema::hasColumn('countries', 'calling_code'))
		{
			Schema::table('countries', function (Blueprint $table)
			{
				$table->string('calling_code', 10)
					->nullable()
					->after('timezone')
					->comment('ITU-T E.164 country calling code, e.g. +40');
			});
		}

		foreach ($this->callingCodes() as $code => $callingCode)
		{
			DB::table('countries')
				->where('code', $code)
				->whereNull('calling_code')
				->update(['calling_code' => $callingCode]);
		}
	}
	 ...
	 *
	 * Inlined (rather than required from ../data/calling-codes.php) so the
	 * migration is self-contained and survives `vendor:publish` without
	 * depending on a sibling data file the user did not publish.
	 *
	 * @return array<string, string>
	 */
	private function callingCodes(): array
	{
		return [
			...
			'FJ' => '+679', 'FM' => '+691', 'FR' => '+33',  'GA' => '+241',
			'GB' => '+44',  'GD' => '+1',   'GE' => '+995', 'GH' => '+233',
			'GM' => '+220', 'GN' => '+224', 'GQ' => '+240', 'GR' => '+30',
			'GT' => '+502', 'GW' => '+245', 'GY' => '+592', 'HN' => '+504',
			...
			'MH' => '+692', 'MK' => '+389', 'ML' => '+223', 'MM' => '+95',
			'MN' => '+976', 'MR' => '+222', 'MT' => '+356', 'MU' => '+230',
			...
			'PL' => '+48',  'PS' => '+970', 'PT' => '+351', 'PW' => '+680',
			'PY' => '+595', 'QA' => '+974', 'RO' => '+40',  'RS' => '+381',
			'RU' => '+7',   'RW' => '+250', 'SA' => '+966', 'SB' => '+677',
			'SC' => '+248', 'SD' => '+249', 'SE' => '+46',  'SG' => '+65',
			'SI' => '+386', 'SK' => '+421', 'SL' => '+232', 'SM' => '+378',
			'SN' => '+221', 'SO' => '+252', 'SR' => '+597', 'SS' => '+211',
			'ST' => '+239', 'SV' => '+503', 'SY' => '+963', 'SZ' => '+268',
			'TD' => '+235', 'TG' => '+228', 'TH' => '+66',  'TJ' => '+992',
			'TL' => '+670', 'TM' => '+993', 'TN' => '+216', 'TO' => '+676',
			'TR' => '+90',  'TT' => '+1',   'TV' => '+688', 'TW' => '+886',
			'TZ' => '+255', 'UA' => '+380', 'UG' => '+256', 'US' => '+1',
			'UY' => '+598', 'UZ' => '+998', 'VA' => '+379', 'VC' => '+1',
			'VE' => '+58',  'VN' => '+84',  'VU' => '+678', 'WS' => '+685',
